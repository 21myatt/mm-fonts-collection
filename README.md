...
A responsive, searchable preview for **132 Myanmar Unicode font faces**, powered
by the production [`mm-fonts-cdn`](https://github.com/21myatt/mm-fonts-cdn)
catalog.

**Live site:** <https://21myatt.github.io/mm-fonts-collection/>
...
The Vite base path is `/mm-fonts-collection/`, matching the repository name.
