...
export function createWordArtConfig(preset: WordArtPreset, usePresetDefaults = true): WordArtConfig {
  const base = { fillEnabled: true, fillPaint: "solid" as const, fillOpacity: 1, outlineEnabled: true, outlinePaint: "solid" as const, outlineWidth: 1, outlineOpacity: 1, outlineGradientStart: "#ffffff", outlineGradientMiddle: "#ffffff", outlineGradientEnd: "#000000", outlineGradientAngle: 180, outlineGradientType: "linear" as const, shadowEnabled: false, depthEnabled: false, depthColor: "#666666", fill: "#111111", outline: "#000000", shadow: "#999999", rotation: 0, shadowX: 4, shadowY: 4, gradientEnabled: false, gradientStart: "#ffffff", gradientMiddle: "#ffffff", gradientEnd: "#000000", gradientAngle: 180, gradientType: "linear" as const, gradientCustom: false, fontSize: 0, fontWeight: 0, fontStyle: "normal" as const, letterSpacing: 0, scaleX: 1, scaleY: 1, skewX: 0, skewY: 0, perspective: 0, translateX: 0, translateY: 0, rotateX: 0, rotateY: 0, rotateZ: 0, shadowDepth: 4, shadowOpacity: 1, textureSize: 100, textureAngle: 0, arcEnabled: false, arcOrientation: "horizontal" as const, arcRadius: 240, arcAngle: 0, arcHorizontalDistortion: 0, arcVerticalDistortion: 0, layerDepth: 8, layerAngle: 45, bevel: 0 };
  const config = { ...base, ...(usePresetDefaults ? { shadowEnabled: true, ...defaults[preset] } : {}) };
  return { ...config, fillPaint: config.gradientEnabled ? "gradient" : config.fillPaint };
}
